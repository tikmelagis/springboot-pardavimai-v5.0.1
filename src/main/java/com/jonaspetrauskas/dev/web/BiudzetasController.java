...
import com.jonaspetrauskas.dev.service.BiudzetasService;
...
public class BiudzetasController {
        ...
        if(metai!=null) {
            if(menuo!=null && unitasName!=null) {
                ...
                if (biudzetasRep.existsByMetaiAndMenuoAndBusinessUnit(metai, menuo, bus) == true) {
                    ...
                    mv.addObject("biudzetasDarbuotojai", biudzetasService.biudzetoInfoPagalUser(metai));
            ...
            mv.addObject("biudzetasDarbuotojai", biudzetasService.biudzetoInfoPagalUser(String.valueOf(LocalDate.now().getYear())));
            mv.addObject("menesiai", biudzetasService.menesiai());
            mv.addObject("addUpBud", new Biudzetas());
    ...
    public ModelAndView addbudup(@ModelAttribute("addUpBud")Biudzetas biudzetas,
        ...
        mv.setViewName("redirect:/biudzetas?metai1="+metai+"&scrolas="+scrolas);
        return mv;
    }
