...
<div style="width: 100%; height:80px;">
    ...
    <div style="width: 100px; height: 60px; display: inline-block; position: absolute; right:50px">
        <button style="float:right; " onclick="location.href='?pardavimoid=new&metais=${pasirinktiMetai}'" class="btn btn-blue-grey" >  Add</button>
    </div>
                    ...
                    <c:forEach items="${Iketvirtis}" var="pirmasketvertis">
                        <div class="st_row2">
                            ...
                            <div class="st_column _mygtukai2">
                                ...
                                <button onclick="location.href='?pardavimoid=${pirmasketvertis.id}&metais=${pasirinktiMetai}'" class="btn btn-blue-grey btn-sm" style="height:20px; width:40px;padding: 0;margin: 0; ">
                                    <i class="far fa-edit"></i>
                                </button>
                                    <button onclick="location.href='${contextPath}/pardavimolent/${pirmasketvertis.id}/delete?metais=${pasirinktiMetai}'"  class="btn btn-blue-grey btn-sm" style="height:20px; width:40px;padding: 0;margin: 0; ">
                    ...
                    <c:forEach items="${IIketvirtis}" var="a2ketvertis">
                        <div class="st_row2">
                            ...
                            <div class="st_column _mygtukai2">
                                ...
                                <button onclick="location.href='?pardavimoid=${a2ketvertis.id}&metais=${pasirinktiMetai}'" class="btn btn-blue-grey btn-sm" style="height:20px; width:40px;padding: 0;margin: 0;">
                                    <i class="far fa-edit"></i>
                                </button>
                                    <button onclick="location.href='${contextPath}/pardavimolent/${a2ketvertis.id}/delete?metais=${pasirinktiMetai}'"  class="btn btn-blue-grey btn-sm" style="height:20px; width:40px;padding: 0;margin: 0; ">
                                        <i class="fas fa-trash-alt"></i>
                                    </button>
                    ...
                    <c:forEach items="${IIIketvirtis}" var="a3ketvertis">
                        <div class="st_row2">
                            ...
                            <div class="st_column _mygtukai2">
                                ...
                                <button onclick="location.href='?pardavimoid=${a3ketvertis.id}&metais=${pasirinktiMetai}'" class="btn btn-blue-grey btn-sm" style="height:20px; width:40px;padding: 0;margin: 0; ">
                                    <i class="far fa-edit"></i>
                                </button>
                                    <button onclick="location.href='${contextPath}/pardavimolent/${a3ketvertis.id}/delete?metais=${pasirinktiMetai}'"  class="btn btn-blue-grey btn-sm" style="height:20px; width:40px;padding: 0;margin: 0;">
                                        <i class="fas fa-trash-alt"></i>
                                    </button>
                    ...
                    <c:forEach items="${IVketvirtis}" var="a4ketvertis">
                        <div class="st_row2">
                            ...
                            <div class="st_column _mygtukai2">
                                ...
                                <button onclick="location.href='?pardavimoid=${a4ketvertis.id}&metais=${pasirinktiMetai}'" class="btn btn-blue-grey btn-sm" style="height:20px; width:40px;padding: 0;margin: 0;" >
                                    <i class="far fa-edit"></i>
                                </button>
                                    <button onclick="location.href='${contextPath}/pardavimolent/${a4ketvertis.id}/delete?metais=${pasirinktiMetai}'"  class="btn btn-blue-grey btn-sm" style="height:20px; width:40px;padding: 0;margin: 0;">
                                        <i class="fas fa-trash-alt"></i>
                                    </button>
...
<div class="modal fade" id="modalUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalUpdate"
    ...
    <div class="modal-dialog modal-lg" role="document" >
        <div class="modal-content" >
            ...
            <form:form method="post"  action="${contextPath}/addPardavima?metais=${pasirinktiMetai}" modelAttribute="pardavimas" >
